...
describe('handleEnrich', () => {
  ...
  // Offline default: no network enrichment unless --use-github; mark as skipped with reason
  // Note: a newer test below also verifies the same behavior with explicit assertions
  // on { skipped: true, reason: 'flag:not_set' }.

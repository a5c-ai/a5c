...
describe('README examples', () => {
  it('normalizes sample workflow_run and writes out.json', () => {
    ...
    run('node dist/cli.js normalize --in samples/workflow_run.completed.json --out out.json')
  ...
  it('extracts mentions from stdin', () => {
    ...
    const json = run(`printf "%s" "$MSG" | node dist/cli.js mentions --source issue_comment`, {
